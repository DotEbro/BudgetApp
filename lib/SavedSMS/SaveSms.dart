  ...
  Future<void> savedSMS(String name, String sms) async {
    ...
    for (int i = 0; i < 3; i++) {
      if (sms.toLowerCase().contains(keywordList[i])) {
        ...
        print("\nSuccess!");
        _db.saveSMSInformation(id, name, bank, date, debited, credited, place, time12, category, saveDateTime);
        break;
      } else {
        print("\nLost!");
      }
