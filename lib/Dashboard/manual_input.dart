                ...
                Container(
                  ...
                  child: TextFormField(
                    ...
                    onChanged: (value){
                      setState((){
                        _income_expense == 0.0
                            ? credited = "+${widget.userData.currency} ${amountController.text}"
                            : debited = "-${widget.userData.currency} ${amountController.text}";
                      });
                    },
                  ),
                ),
                ...
                Container(
                  ...
                  child: ListView.separated(
                    ...
                    itemBuilder: (context, index) => GestureDetector(
                      onTap: () {
                        setState(() {
                          _income_expense = index.toDouble();
                          if(_income_expense == 0.0) {
                            credited = "+${widget.userData.currency} ${amountController.text}";
                            debited = "0";
                          }else{
                            debited = "-${widget.userData.currency} ${amountController.text}";
                  ...
                  child: TextFormField(
                    ...
                    onTap: () async {
                      ...
                      if (pickedTime != null) {
                        ...
                        time12 = DateFormat("h:mma").format(parsedTime);
                        String formattedTime = DateFormat('HH:mm:ss').format(parsedTime);
                        print(formattedTime);
                        setState(() {timeController.text = formattedTime;});
                        saveTime = parsedTime;
                        saveDateTime = DateTime(saveDate.year, saveDateTime.month, saveDate.day, saveTime.hour, saveTime.minute, saveTime.second);
                      } else {
                      ...
                      child: ElevatedButton(
                        ...
                        onPressed: () async {
                          if (_formKey.currentState!.validate()) {
                            ...
                            // print("id $id");
                            await _db.saveSMSInformation(id, widget.userData.userID, bank, dateController.text, debited, credited, place, time12, category, saveDateTime);
