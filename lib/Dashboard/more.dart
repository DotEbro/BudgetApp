...
import '../Settings/CurrencyScreen.dart';
        ...
        sections: [
          ...
          SettingsSection(
            ...
            tiles: [
              ...
              SettingsTile(title: Text('currency'.tr,  style: TextStyle(fontSize: 15),), leading: Icon(Icons.money, size: 19,),
                onPressed: (context){
                  Navigator.of(context).push(
                      MaterialPageRoute(builder: (context) => CurrencyScreen(currency: widget.userData.currency, id: widget.userData.userID,))
                  );
                },
              ),
