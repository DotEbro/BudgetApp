...
class _PieChartScreenState extends State<PieChartScreen> {
  ...
  double Amount_current = 0;
  @override
  initState(){
    super.initState();
    setDataMap();
    Current_amount = getThisMonAmount();
    Amount_current = double. parse((Current_amount). toStringAsFixed(3));
  }
  @override
