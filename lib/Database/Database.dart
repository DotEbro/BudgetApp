...
class DataBase{
  ...
  Future saveSMSInformation(String id, String name, String bank, String date, String debited, String credited, String place, String time, String category, DateTime datetime)async{
  ...
  Future updateCurrency(String userID, String currency) async{
    final doc = FirebaseFirestore.instance.collection("UserData").doc(userID);
    doc.update({
      "Currency" : currency,
    });
  ...
  Stream<List<UserTransactionData>> getUserTransaction(String id) => FirebaseFirestore.instance
      .collection(id).orderBy('DateTime', descending: true)
      .snapshots()
